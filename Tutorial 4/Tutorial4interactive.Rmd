...
fastFoodData <- read_csv("fastfood_calories.csv")
...
pulseData <- read_table("https://raw.githubusercontent.com/kellya72/R-tutorials/master/Tutorial%204/pulse.txt")
pulseData 
```
...
fastFoodData <- read.csv("https://raw.githubusercontent.com/kellya72/R-tutorials/master/Tutorial%204/fastfood_calories.csv", stringsAsFactors = FALSE)
fastFoodData
```
