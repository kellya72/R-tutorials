...
- We can creates a heatmap coloured according to *Income*.
...
```{r wind-turbines-setup ,exercise=TRUE, exercise.setup = "wind-turbines-prep", exercise.timelimit=60, exercise.lines=9, warning=FALSE, error=FALSE, message=FALSE}
states = map_data("state") 
