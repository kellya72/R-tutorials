...
- When creating plots in RStudio you need to load the tidyverse package.

- The package first needs to be installed by running the following line of code:
...
knitr::include_graphics("images/Install packages.png")
```
...
```{r firstScatterplot, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = mpg) + 
...
```{r colourScatter, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = mpg) + 
...
```{r shade, message=FALSE, warning=FALSE, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = mpg) + 
...
```{r basicBarplot, exercise= TRUE, exercise.eval= TRUE}
...
```{r barplotColour, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = diamonds) + 
...
```{r barplotVarColour, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = diamonds) + 
...
```{r otherBarplot, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = diamonds) + 
...
```{r basicHistogram, exercise= TRUE, exercise.eval= TRUE}
...
```{r, echo=FALSE,fig.align = 'center', fig.cap='Image sourced from www.flowingdata.com'}
knitr::include_graphics("images/box-plot-explained.gif")
```


### Basic Boxplot

```{r basicBoxplot, exercise= TRUE, exercise.eval= TRUE}
...
```{r colourBoxplot, exercise= TRUE, exercise.eval= TRUE}
...
```{r boxplotNoLegend, exercise= TRUE, exercise.eval= TRUE}
ggplot(data = mpg, mapping = aes(x = drv, y = cty, fill= drv)) + 
