...
```{r coord_simple , message=FALSE, warning=FALSE}  
ggplot(mpg) +
...
```{r coord_advanced , message=FALSE, warning=FALSE}  
ggplot(mpg) +
  geom_point(aes(displ, hwy)) +
...
```{r Edge_theme , warning=FALSE, exercise.lines=27}
...
```{r animate_prep, exercise=TRUE, warning=FALSE, error=FALSE, message=FALSE}
 # Load data
voter_data <- read_csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2018/2018-10-09/voter_turnout.csv")
...
```{r animate2, exercise=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r animate, exercise=TRUE, warning=FALSE, error=FALSE, message=FALSE}
...
```{r wind-turbines-prep , warning=FALSE, error=FALSE, message=FALSE}
library(gganimate)
library(scales)
library(maps)
...
```{r wind-turbines-setup , warning=FALSE, error=FALSE, message=FALSE}
states = map_data("state") 
...
```{r wind-turbines-animation, warning=FALSE, error=FALSE, message=FALSE}
